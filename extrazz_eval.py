...
training_methods_list = ['validation_score','one_sem','one_sem_grd','gso_1','gso_2']
# training_methods_list = ['validation_score']
# shap_values_list = ['M8','M18','M32']
estimators_list = ['LinearDiscriminantAnalysis','GaussianProcessClassifier']
...
for csv_dir in csv_dir_list:
    for training_method in training_methods_list:
        for estimator in estimators_list:
            ...
            df_all.to_csv('paper_evaluation_shap_4.csv')
