...
optuna_grid = {'NestedCV': 
    ...
    'GradientBoostingClassifier': {
        'loss': optuna.distributions.CategoricalDistribution(['log_loss', 'exponential']),
    ...
    'ManualSearch': {
            ...
            'SVC': lambda trial: SVC(
                ...
                degree=(trial.suggest_int('degree', 1, 10) if trial.params.get('kernel') == 'poly' else 3),
            ...
            'LinearDiscriminantAnalysis': lambda trial: LinearDiscriminantAnalysis(
                ...
                shrinkage=(trial.suggest_float('shrinkage', 0.0, 1.0) if trial.params.get('solver') != 'svd' else None),
