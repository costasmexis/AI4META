...
class MachineLearningEstimator(DataLoader):
    ...
    def bayesian_search(self, X=None, y=None, scoring='matthews_corrcoef', 
                        direction='maximize', n_trials=100, features_list=None, feat_num=None, 
                        feat_way='mrmr', cv=5, verbose=True, return_model=False):
        ...
        self.best_estimator = self.available_clfs[self.name].set_params(**self.best_params)
